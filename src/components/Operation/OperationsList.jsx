...
const OperationsList = () => {
    ...
    const getAllOperations = () => {
      OperationService.getAllOperations().then((response) => {
    ...
    const deleteOperation = (operationId) => {
      OperationService.deleteOperation(operationId).then((response) =>{
        getAllOperations();
  ...
  return (
    <div>
      ...
      <Link to = "/add-operation" className = "btn btn-primary mb-2" > Add Operation </Link>
